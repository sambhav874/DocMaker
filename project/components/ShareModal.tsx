...
import { faClose, faCross, faShare } from "@fortawesome/free-solid-svg-icons";
...
<Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger>
          <Button disabled={currentUserType !== 'viewer'} className="flex items-center justify-center space-x-1 p-2 text-white bg-dark-300 hover:bg-white hover:text-dark-200">
            Share
            <FontAwesomeIcon icon={faShare} className="h-4 w-4 text-xl font-light hover:text-dark-200 px-2" />
          </Button>
        </DialogTrigger>
              ...
              <DialogHeader>
                <DialogTitle>
                  <div className="flex group items-center justify-between">
                    <p className="text-lg text-white group-hover:white font-semibold">Manage who can access the document
